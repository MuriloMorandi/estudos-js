...
taskRoutes.get("/", validate(paginationSchema, "query"), taskController.getAll.bind(taskController));

taskRoutes.get("/:id", taskController.getById.bind(taskController));

taskRoutes.post("/", validate(createTaskSchema, "body"), taskController.create.bind(taskController));

taskRoutes.put("/:id", validate(updateTaskSchema, "body"), taskController.update.bind(taskController));
