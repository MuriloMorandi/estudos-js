<template>
    <div class="full-width q-pa-md">
        ...
        <q-table
            ...
            <template v-if="!isMobile" v-slot:top-left>
                ...
                <q-input  dense filled   label="Pesquisa" stack-labe debounce="300" v-model="filter" class="q-ml-md">
            ...
            <template v-slot:[selectSlot]>
                ...
                <q-badge v-if="!hideTotalRows" :class="[
                    'text-subtitle2 d-flex justify-center align-center non-selectable',
                    !isMobile && 'full-width'
                ]" style="height: 38px" color="grey-5" outline>
    ...
    <q-dialog v-model="hideDialog">
        <q-card style="min-width: 400px; width: 40vw">
            <q-card-section class="row bg-grey-2" style="height:fit-content;"
                :style="isMobile ? '' : 'border-bottom: 1px #e8e8e8 solid;'">
                <p class="q-ma-none text-h6 non-selectable">
                    Editar Colunas
                </p>
                <q-space />
...
const rowsPerPageOptions = computed(() =>
    isMobile.value
        ...
        :[1, 10, 15, 20, 25, 30, 50, 100, 200] 
);

const selectSlot = computed(() =>
    isMobile.value ? 'top' : 'top-right'
);
